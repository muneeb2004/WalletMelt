---
name: dart_skill
description: Programming guidelines for null safety, model immutability, error handling, sorting, filtering, and API compatibility.
---

# WalletMelt Dart Skill
...
## Hard Rules
- Avoid using `dynamic` parameters unless strictly justified.
- Write small, clean, reviewable, and reversible diffs.
- Avoid introducing changes to public models that break backward compatibility.
