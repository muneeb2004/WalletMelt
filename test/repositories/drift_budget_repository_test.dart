...
void main() {
  test('upserts, lists, sorts, and deletes category budgets by month', () async {
    ...
    await repository.upsert(categoryId: 'grocery', amount: 35000, currency: 'PKR', month: '2026-06');
    budgets = await repository.listForMonth('2026-06');
    expect(budgets.where((budget) => budget.categoryId == 'grocery'), hasLength(1));
    expect(budgets.singleWhere((budget) => budget.categoryId == 'grocery').amount, 35000);
