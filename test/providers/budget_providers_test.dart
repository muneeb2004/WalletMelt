...
void main() {
  test('monthlyBudgetsProvider returns V1-compatible sorted budgets', () async {
    ...
    final repository =
        await container.read(driftBudgetRepositoryProvider.future);
    ...
    final budgets =
        await container.read(monthlyBudgetsProvider('2026-06').future);
  ...
  test(
      'budgetByCategoryProvider resolves and reflects delete after invalidation',
      () async {
    final container = _containerWithMemoryDatabase();
    addTearDown(container.dispose);
