...
void main() {
  group('validateExpenseInput', () {
    test('rejects missing and non-positive amount', () {
      expect(
          validateExpenseInput(
                  amount: '', categoryId: 'rent', date: DateTime(2026))
              .isValid,
          isFalse);
      expect(
          validateExpenseInput(
                  amount: '-4', categoryId: 'rent', date: DateTime(2026))
              .amountError,
          isNotNull);
      expect(
          validateExpenseInput(
                  amount: '0', categoryId: 'rent', date: DateTime(2026))
              .amountError,
          isNotNull);
    });
    ...
    test('requires category and date', () {
      final result =
          validateExpenseInput(amount: '1200', categoryId: null, date: null);
