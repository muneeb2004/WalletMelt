...
class BudgetLookup {
  ...
  bool operator ==(Object other) {
    return other is BudgetLookup && other.month == month && other.categoryId == categoryId;
  }
...
final monthlyBudgetsProvider = FutureProvider.family<List<CategoryBudget>, String>((ref, month) async {
  final repository = await ref.watch(driftBudgetRepositoryProvider.future);
  return repository.listForMonth(month);
});

final budgetByCategoryProvider = FutureProvider.family<CategoryBudget?, BudgetLookup>((ref, lookup) async {
