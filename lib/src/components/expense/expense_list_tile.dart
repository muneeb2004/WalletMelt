...
class ExpenseListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = category == null ? WalletMeltColors.textMuted : colorFromHex(category!.color);
    return Material(
      ...
      child: ListTile(
        ...
        subtitle: Text('${category?.name ?? 'Unknown'} • ${readableDate(parseIsoDate(expense.date))}'),
        trailing: Text(
